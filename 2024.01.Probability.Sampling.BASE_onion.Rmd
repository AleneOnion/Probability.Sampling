...
#rm(list=setdiff(ls(), c("newdata","obt")))
...
rm(list=setdiff(ls(), c('newdata',"att","sites","obt")))
...
table <- CatExtent %>% 
  ...
  mutate(Category=factor(Category, levels=c("Poor","Fair","Good",
         ...
         Indicator=case_when(
           Indicator=="phos_trophic"~"Total phosphorus", 
           Indicator=="chla_trophic"~"Chlorophyll-a", 
           Indicator=="TP_threshold"~"hosphorus", 
...
att <- att %>% rename("CHLOROPHYLL_ug_L"=`CHLOROPHYLL A_OW_TOTAL`,
                      ...
                      "Ammonia_mg_L"=`NITROGEN, AMMONIA (AS N)_OW_TOTAL`,
                      "Arsenic_ug_L"=ARSENIC_OW_TOTAL,
                      "Iron_ug_L"=IRON_OW_TOTAL,
                      "Magnesium_ug_L"=MAGNESIUM_OW_TOTAL,
                      "Manganese_ug_L"=MANGANESE_OW_TOTAL,
                      "Nitrate_mg_L"=`NITROGEN, NITRATE (AS N)_OW_TOTAL`,
                      "Nitrate_Nitrite_mg_L"=`NITROGEN, NITRATE-NITRITE_OW_TOTAL`,
                      "Nitrite_mg_L"=`NITROGEN, NITRITE_OW_TOTAL`,
                      "PH_epi"=PH_epi,
                      "Sulfate_mg_L"=`SULFATE (AS SO4)_OW_TOTAL`,
                      "Specific_conductivity_epi"=`SPECIFIC CONDUCTANCE_epi`,
                      "Calcium_mg_L"=CALCIUM_OW_TOTAL,
                      "Color"=`TRUE COLOR_OW_TOTAL`,
                      "Secchi_depth"=`DEPTH, SECCHI DISK DEPTH_SD_NA`)

vars <- c("CHLOROPHYLL_ug_L","NITROGEN_mg_L","PHOSPHORUS_mg_L","DISSOLVED_OXYGEN_mg_L","ALKALINITY_mg_L","CHLORIDE_mg_L","Ammonia_mg_L","Arsenic_ug_L","Iron_ug_L","Magnesium_ug_L","Manganese_ug_L","Nitrate_mg_L","Nitrate_Nitrite_mg_L","Nitrite_mg_L","PH_epi","Sulfate_mg_L","Specific_conductivity_epi","Calcium_mg_L","Color","Secchi_depth")
...
myvars <- c("CHLOROPHYLL_ug_L","NITROGEN_mg_L","PHOSPHORUS_mg_L","DISSOLVED_OXYGEN_mg_L","ALKALINITY_mg_L","CHLORIDE_mg_L","Ammonia_mg_L","Arsenic_ug_L","Iron_ug_L","Magnesium_ug_L","Manganese_ug_L","Nitrate_mg_L","Nitrate_Nitrite_mg_L","Nitrite_mg_L","PH_epi","Sulfate_mg_L","Specific_conductivity_epi","Calcium_mg_L","Color","Secchi_depth")
...
#NLA
vars<-c("phos_trophic","TN_threshold","CHLA_threshold","d.oxygen","chloride")
...
```{r all dots plot}
#can't get NY trophic category to work
