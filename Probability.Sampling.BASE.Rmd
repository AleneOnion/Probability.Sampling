...
cats <- rbind(ny.cat,nh.cat,nla.cat,nap.cat) #combine results from all categorical analyses
...
myvars <- c("CHLOROPHYLL_ug_L","NITROGEN_mg_L","PHOSPHORUS_ug_L","CHLORIDE_mg_L","DOC_mg_L","CALCIUM_mg_L","TRUE_COLOR","SPEC_CONDUCTANCE","AMMONIA_N","MAGNESIUM_OW_TOTAL","SECCHI_m","NP_ratio")
