...
frame<-att %>% 
  ...
  mutate(NLA = case_when(
    endsWith(size_category, "(1,4]") ~ ((478/4271)*100),
    endsWith(size_category, "(4,10]") ~ ((1184/4271)*100),
    endsWith(size_category, "(10,20]") ~ ((1002/4271)*100),
    endsWith(size_category, "(20,50]") ~ ((738/4271)*100),
    endsWith(size_category, ">50") ~ ((869/4271)*100))) %>%
  ungroup() %>%
