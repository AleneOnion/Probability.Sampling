...
att<-att %>% 
  mutate(WgtAdj=case_when(
         AREA_CAT6=="(1,4]"~(20/6),
         AREA_CAT6=="(4,10]"~(44/16),
         AREA_CAT6=="(10,20]"~(46/24),
         AREA_CAT6=="(20,50]"~(60/31),
         AREA_CAT6==">50"~(66/37)))

print(sum(att$WgtAdj))

framesize_LC <- c("EPA"=236) 
...
ny.locs <- read.csv("~/OneDrive - New York State Office of Information Technology Services/Rscripts/Probability.Sampling/Probability_Based_Sites_2020_2021.csv") %>% 
