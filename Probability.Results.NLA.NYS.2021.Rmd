...
att<-att %>% 
  mutate(WgtAdj=case_when(
         AREA_CAT6=="(1,4]"~(478/67),
         AREA_CAT6=="(4,10]"~(1184/188),
         AREA_CAT6=="(10,20]"~(1002/211),
         AREA_CAT6=="(20,50]"~(738/237),
         AREA_CAT6==">50"~(869/357)))
...
frame<-att %>% 
  ...
  mutate(NLA = case_when(
    endsWith(size_category, "(1,4]") ~ ((67/4271)*100),
    endsWith(size_category, "(4,10]") ~ ((188/4271)*100),
    endsWith(size_category, "(10,20]") ~ ((211/4271)*100),
    endsWith(size_category, "(20,50]") ~ ((237/4271)*100),
    endsWith(size_category, ">50") ~ ((357/4271)*100))) %>%
  ungroup() %>%
...
ggplot(frame, aes(x=size_category,y=percentage,color=study)) +
