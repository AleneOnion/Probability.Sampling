...
Below: using the number of sampled lakes in each dissolved oxygen condition category to estimate the ratio of the 2423 lakes we could have sampled that are in each EPA condition cateogry. 
