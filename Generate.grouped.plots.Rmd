...
vars.list <- list(Trophic=trophic,Minerals=minerals,Salt=salt,`In Situ`=in.situ,HABs=habs)
...
vars.list <- list(Trophic=trophic,Minerals=minerals,Salt=salt,`In Situ`=in.situ)
...
for(i in vars.list){
  ...
  table<-analysis$CDF %>% 
    ...
    mutate(Indicator=case_when(
      ...
      Indicator=="DISSOLVED_OXYGEN_mg_L"~"Epilimnetic dissolved oxygen (mg/L)",
      ...
      Indicator=="SPEC_CONDUCTANCE"~"Specific conductance (mS/cm)",
