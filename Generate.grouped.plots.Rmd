...
trophic <- c("phos_trophic","chla_trophic","d.oxygen","N_LIMIT","secchi","leech","color")
minerals <- c("zebra","chloride","alkalinity")
in.situ <- c("ph","conductance")
habs <- c("microcystin","chlorophyte","cryptophyta","cyanobacteria","dinophyta")

vars.list <- list(trophic,minerals,in.situ,habs)
...
plot<-ggplot(table,aes(x=Category,y=Estimate.P)) +
  ...
  ylim(0,100)+
  labs(y="Percent of Total",x="Condition category")
